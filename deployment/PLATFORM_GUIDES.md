...
name: backend
source:
  repo: ayushkarnewar1519-bot/DrishyaMitra
  branch: main
  root_dir: /backend
...
```bash
cd /home/deploy
git clone https://github.com/ayushkarnewar1519-bot/DrishyaMitra.git
cd DrishyaMitra
```
...
- Open issue: https://github.com/ayushkarnewar1519-bot/DrishyaMitra/issues
